...
void main() {
  group('MedicineLookupRepository', () {
    ...
    test(
      'search by name resolves a local brand name and falls back to the generic name',
      () async {
        final apiClient = _FakeApiClient(
          getJsonHandler:
              ({
        ...
        final result = await repository.searchByName('Nurofen 200mg tablets');

        expect(result.medicineName, 'Ibuprofen');
        expect(result.query, 'Nurofen 200mg tablets');
